                ...
                <div class="lv-product__info">
                    ...
                    <div class="d-flex flex-wrap gap-3 my-4">
                        ...
                        <div class="d-flex align-items-center gap-3" style="flex:1 1 220px;">
                            ...
                            <span style="min-width:0;"><strong class="d-block" style="color:#3cb54a;font-style:italic;font-size:17px;">Ahorro</strong><span style="color:#1c1c1c;font-size:14px;line-height:1.3;">Las mejores ofertas para cada pedido</span></span>
                        </div>
                        <div class="d-flex align-items-center gap-3" style="flex:1 1 220px;">
                            <span class="d-inline-flex align-items-center justify-content-center flex-shrink-0" style="width:56px;height:56px;border-radius:50%;border:2px solid #3cb54a;">
                                <svg viewBox="0 0 24 24" width="28" height="28" aria-hidden="true">
                            ...
                            <span style="min-width:0;"><strong class="d-block" style="color:#3cb54a;font-style:italic;font-size:17px;">Envío en España</strong><span style="color:#1c1c1c;font-size:14px;line-height:1.3;">Entrega rápida y segura en toda España</span></span>
                        </div>
                    </div>
