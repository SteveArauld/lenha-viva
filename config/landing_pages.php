...
return [
    ...
    'lena-de-encina' => [
        ...
        'intro' => '<p>La <strong>leña de encina</strong> es la más valorada para calefacción doméstica: es una madera dura y muy densa que arde despacio, genera una brasa duradera y desprende mucho calor con poco humo. En LENHA VIVA vendemos <strong>leña de encina seca</strong>, con un contenido de humedad reducido para que puedas usarla nada más recibirla en tu chimenea, estufa, cocina o caldera de leña.</p>
    ...
    'lena-seca' => [
        ...
        <p>En LENHA VIVA seleccionamos maderas duras, adecuadas para <strong>chimenea, estufa</strong>, cocina y caldera de leña. Compra online y recibe tu pedido con <strong>entrega a domicilio en España</strong> en pocos días laborables.</p>',
        'faqs' => [
    ...
    'lena-para-chimenea' => [
        ...
        <p>En LENHA VIVA puedes <strong>comprar leña para chimenea</strong> ya seca y lista para usar, con el tamaño indicado en cada ficha de producto. Hacemos <strong>entrega a domicilio en España</strong>, para que tengas la leña preparada antes de que llegue el frío.</p>',
        'faqs' => [
    ...
    'lena-para-estufa' => [
        ...
        <p>En LENHA VIVA vendemos <strong>leña para estufa</strong> seca, de maderas duras como la encina, con la longitud indicada en cada ficha. Compra online y recíbela con <strong>entrega a domicilio en España</strong>.</p>',
        'faqs' => [
    ...
    'estufas-de-lena' => [
        ...
        <p>En LENHA VIVA encontrarás <strong>estufas de leña</strong> y cocinas de leña de fabricación robusta, algunas con opción de caldera para agua caliente o calefacción. Realizamos <strong>entrega a domicilio en España</strong>. Complementa tu compra con nuestra <a href="/lena-seca">leña seca</a> lista para arder.</p>',
        'faqs' => [
